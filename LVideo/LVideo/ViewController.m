...
- (void)commonInit {
    ...
    GLuint colorConversionMatrix = glGetUniformLocation(program, "colorConversionMatrix");
    glUniformMatrix4fv(colorConversionMatrix, 1, GL_FALSE, kColor);
